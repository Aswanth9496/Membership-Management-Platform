...
const LandingPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050d1a] px-6 py-12 relative overflow-hidden">
      ...
      <div className="max-w-5xl w-full relative z-10">
        <div className="text-center mb-16 animate-fadeUp">
          <h1 className="font-syne text-5xl md:text-6xl font-bold text-white mb-4 tracking-tight">
            Choose Your Portal
          </h1>
          <div className="h-1.5 w-24 bg-gradient-to-r from-blue-600 to-blue-400 mx-auto rounded-full mb-6"></div>
          <p className="text-slate-400 text-lg max-w-md mx-auto font-inter">
            Select the appropriate gateway to access your dashboard and services.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Link 
            to="/admin/login" 
            className="group relative bg-slate-900/40 backdrop-blur-xl border border-white/5 p-10 rounded-[32px] transition-all duration-500 hover:translate-y-[-10px] hover:bg-slate-900/60 hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_30px_rgba(37,99,235,0.1)] flex flex-col items-center text-center animate-fadeUp"
            style={{ animationDelay: '0.1s' }}
          >
            <div className="w-20 h-20 bg-blue-600/10 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-blue-600/20 transition-colors duration-300">
              <svg 
            ...
            <h2 className="font-syne text-3xl font-bold text-white mb-4">Admin Portal</h2>
            <p className="text-slate-400 font-inter leading-relaxed mb-8 flex-grow">
              Manage members, approvals, and system settings. Access comprehensive analytics and control center.
            </p>
            <div className="w-full py-4 bg-transparent border border-white/10 rounded-xl text-white font-inter font-medium group-hover:bg-blue-600 group-hover:border-blue-600 transition-all duration-300">
              Admin Login
            </div>
          ...
          >
            ...
            <h2 className="font-syne text-3xl font-bold text-white mb-4">User Portal</h2>
            <p className="text-slate-400 font-inter leading-relaxed mb-8 flex-grow">
              Access your dashboard, profile, and membership services. Stay connected with the community.
            </p>
