...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center overflow-hidden relative p-[60px_20px]">
      {/* Background Effects */}
      ...
      <div className="animate-fadeUp">
        <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-3xl p-12 relative overflow-hidden backdrop-blur-xl shadow-2xl max-w-[420px] w-full hover:border-blue-300 transition-all duration-300">
          {/* Logo */}
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-2.5 mb-4">
              ...
              <span className="font-syne font-bold text-2xl text-gray-900 tracking-tight">Admin<span className="text-blue-600">Portal</span></span>
            </div>
            <div className="inline-block px-3 py-1 bg-blue-100 border border-blue-200 rounded-md text-xs font-medium text-blue-700 tracking-widest uppercase mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="animate-fadeUp" style={{ animationDelay: '0.2s' }}>
              <div className="mb-6">
                <label className="block text-gray-700 text-sm font-medium mb-2 tracking-wide">
                  Email Address
                </label>
                <input
                  type="email"
                  ...
                  className={`w-full bg-white border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-xl px-5 py-4 text-gray-900 text-sm font-inter transition-all duration-300 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 placeholder:text-gray-500`}
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full bg-white border ${errors.password ? 'border-red-500' : 'border-gray-300'} rounded-xl px-5 py-4 text-gray-900 text-sm font-inter transition-all duration-300 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 placeholder:text-gray-500`}
          ...
          <div className="text-center mt-8">
            <Link to="/" className="text-gray-600 text-sm hover:text-blue-600 transition-colors duration-200 inline-flex items-center gap-2">
              ← Back to Home
            </Link>
          </div>
        </div>
